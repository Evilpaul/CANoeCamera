...
namespace AForge.Math
{
    ...
    public struct Matrix4x4 : IEquatable<Matrix4x4>
    {
        ...
        public static Matrix4x4 CreatePerspective(float width, float height, float nearPlaneDistance, float farPlaneDistance)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(nearPlaneDistance), "Must be greater than zero.");
            }

            if (farPlaneDistance <= 0)
            {
                throw new ArgumentOutOfRangeException(nameof(farPlaneDistance), "Must be greater than zero.");
            }
        ...
        /// </summary>
        /// 
        /// <param name="other">The matrix to test equality with.</param>
        /// 
        /// <returns>Returns <see langword="true"/> if the two matrices are equal or <see langword="false"/> otherwise.</returns>
        /// 
